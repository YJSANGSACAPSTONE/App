  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        <Text style={styles.label}>고유 코드 발급</Text>
        {/* <Text style={styles.userData}></Text> */}

        <Text style={styles.label}>발급된 10자리 코드를 출력하거나 적어두시기 바랍니다.
본 코드는 갓생플래너 사이트에서 zep id 인증을 위해서 사용됩니다.</Text>
        <TextInput
          style={styles.input}
          value={chargeAmount}
        ...
        <Button title="인증 완료" onPress={handleCharge} style={styles.button} />
      </View>
    </View>
  );
};
